...
public class AnimationController extends BorderPane {
  ...
  public AnimationController() {
    ...
    sortButton.setStyle("-fx-background-color: white; -fx-border-color: grey; -fx-border-radius: 5;");
    this.randomButton = new Button("Random");
    randomButton.setStyle("-fx-background-color: white; -fx-border-color: grey; -fx-border-radius: 5;");
    this.choiceBox = new ChoiceBox<>();
    choiceBox.setStyle("-fx-background-color: white; -fx-border-color: grey; -fx-border-radius: 5;");
